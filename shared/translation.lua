    ...
    Portugues = {
        ...
        MenuCreation = {
            ...
            element3 = {
                ...
                desc =
                "Escolha um nome para o seu personagem e certifique-se de ler as regras para nomeação de personagens,<br> se você não seguir as regras, este personagem será excluído sem aviso prévio."
            },
