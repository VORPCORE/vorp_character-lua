    ...
    Spanish = {
        ...
        Inputs = {
            ...
            MenuCreation = {
                ...
                element = { etiqueta = "Apariencia", desc = "Elige la apariencia de tu personaje" },
                element2 = { etiqueta = "Ropa", desc = "Elige la ropa para tu personaje" },
                element3 = {
                    etiqueta = "Elige un nombre",
                    desc =
                        "Elige un nombre para tu personaje. Si eliges un nombre y apellido inadecuado, el personaje será eliminado sin previo aviso",
                },
                element4 = { etiqueta = "Empezar", desc = "Pulsa ENTER para empezar con tu supervivencia" },
                element5 = { etiqueta = "Edad", desc = "Edad de tu personaje" },
                element6 = {
