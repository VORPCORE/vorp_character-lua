...
Translation.Langs = {
    ...
    Portugues_PT = {
        ...
        MenuCreation = {
            ...
            element3 = {
                ...
                desc = "Escolha um Nome para o seu Personagem<br> Se utilizar um nome proibido o personagem será eliminado."
            },
    ...
    Portugues_BR = {
        ...
        MenuCreation = {
            ...
            element3 = {
                label = "Escolha um Nome",
                desc = "Escolha um nome para o seu personagem e certifique-se de ler as regras para nomeação de personagens,<br> se você não seguir as regras, este personagem será excluído sem aviso prévio."
            },
        ...
        MenuClothes = {
            ...
            Pant        = "Calças",
            Boots       = "Botas",
            Spurs       = "Acessórios de Botas",
            Bracelet    = "Pulseiras",
            Buckle      = "Fivelas de Cinto",
            Skirt       = "Saias",
            Chap        = "Chapéus de Cowboy",
            Spats       = "Polainas",
            GunbeltAccs = "Acessórios de Coldres",
            Gauntlets   = "Manoplas",
            Loadouts    = "Cargas",
            Accessories = "Acessórios",
            Satchels    = "Mochilas",
            ...
            Holster     = "Coldre Esquerdo",
            Gunbelt     = "Coldres",
            RingRh      = "Anéis Direito",
            RingLh      = "Anéis Esquerdo",
        },
        MenuComponents = {
            title = "Componentes",
            subtitle = "Sub Menu",
        ...
        MenuHeritage = {
            title = "Herança",
            subtitle = "Sub Menu",
            element = { label = "Cor da pele", desc = "existem ", desc2 = "tipos de cor da pele" },
        ...
        MenuHairSelection = {
            title = "Cabelo",
            subtitle = "Escolha o Cabelo do seu Personagem",
            element = { label = "Componente", desc = "Existem ", desc2 = " Tipos" },
            element2 = { label = "Cor", desc = "Existem ", desc2 = " Tipos " },
        },
        MenuBeardEyeBrows = {
            title = "Aparência",
        ...
        MenuLifeStyle = {
            ...
            element = { label = "Sinais", desc = "Ajuste os Sinais" },
            element2 = { label = "Manchas", desc = "Ajuste as Manchas" },
            element3 = { label = "Opacidade", desc = "Escolha a opacidade do Estilo de Vida do seu Personagem" },
            element4 = { label = "Acne", desc = "Ajuste a Acne" },
            element5 = { label = "Sardas", desc = "Ajuste as Sardas" },
            element6 = { label = "Opacidade", desc = "Escolha a opacidade do Estilo de Vida do seu Personagem" },
            element7 = { label = "Cicatrizes", desc = "Ajuste as Cicatrizes" },
            element8 = { label = "Sujeira", desc = "Ajuste a Visibilidade da Sujeira" },
        },
        MenuMakeup = {
    ...
    German = {
        ...
        MenuAppearance = {
            ...
            element5 = { label = "Größe", desc = "Wähle die Art des Körpers deines Charakters<br> Groß 3 normal 2 klein 1 " },
    ...
    Spanish = {
        ...
        promptlabel_select = "Selecciona un género",
        ...
        MenuAppearance = {
            ...
            element5 = { label = "Altura", desc = "Elige el tipo de cuerpo de tu personaje<br>3 = Alto<br>2 = Normal<br>1 = Bajo" },
