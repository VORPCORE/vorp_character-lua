...
Translation.Langs = {
    ...
    Romanian = {
		MainMenu = {
			...
			ReturnMenu        = "Înapoi",
			ReturnMenuDesc    = "Înapoi la selecția caracterelor",
		...
		Other = {
			spinnertext = "Se încarcă selecția de caractere",
		...
		MenuOutfits = {
			title = "Ținute",
			subtitle = "Submeniu",
			option = "Alege unul dintre ținutele tale",
			Select = "Selectează",
			Delete = "Șterge",
		...
		PayToShop = {
			DontMoney = "Nu ai suficient de %s. Suma este: $%s",
			Youpaid = "Ai plătit $%s",
			Total = 'Total:',
			Tokens = 'Fise: ',
			Currency = '$',
		...
		MenuAppearance = {
			...
			element2 = { label = "Caracteristici", desc = "Alege moștenirea caracterului tău", desc2 = "optiuni pentru piele și cap" },
