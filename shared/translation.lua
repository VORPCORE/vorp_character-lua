...
Translation.Langs = {
    English = {
        MainMenu = {
            ...
            Name              = "Name: ",
            Money             = "Money: $ ",
            NameDesc          = "to choose a character press enter",
    ...
    Romanian = {
        MainMenu = {
            NewChar           = "Creeaza un nou caracter",
            NewCharDesc       = "Schimba caracterele apasand tasta Enter",
            Name              = "Nume: ",
            Money             = "Bani: $ ",
            NameDesc          = "Selecteaza caracterul apasand tasta Enter",
            CreateNewCharT    = "Creeaza un caracter nou",
            CreateNewCharDesc = "Schimba caracterele apasand tasta Enter",
            CreateNewSlot     = "Slot disponibil",
            CreateNewChar     = "Creeaza un caracter nou, rescrie-ti povestea, distreaza-te!",
            Choose            = "Alege",
            ChooseDesc        = "Selecteaza acest caracter pentru a-l utiliza in joc",
            Delete            = "Sterge",
            DeleteDesc        = "Sterge acest caracter",
            ReturnMenu        = "Inapoi",
            ReturnMenuDesc    = "Inapoi la selectia caracterelor",
        ...
        PromptLabels = {
            ...
            promptlabel_select = " Selecteaza genul",
            promptlabel_female = "Carcater feminin",
            promptlabel_male = "Caracter masculin",
            promptcreateNew = "Creeaza un nou caracter",
            promptdeleteCurrent = "Sterge acest caracter",
            promptswapChar = "Schimba caracterul",
            promptselectChar = "Selector de Caractere",
            promptback = "inapoi",
            promptsexMale = "Masculin",
            promptsexFemale = "Feminin",
            promptselectConfirm = "Selecteaza",
            promptUpDownCam = "sus/jos",
            promptrotateCam = "roteste",
            promptzoomCam = "zoom",
            CamAdjustments = "Ajustari camera",
        },
        Inputs = {
            confirm = "Confirma",
            ...
            notify = "Apasa ~INPUT_CREATOR_DELETE~ pentru a sterge acest caracter sau apasa ~INPUT_FRONTEND_CANCEL~ pentru a anula",
        ...
        Other = {
            ...
            spinnertext2 = "Se incarca meniul pentru crearea caracterului",
            spinnertext3 = "Fa un screenshot daca doresti",
            Job = "Job: ",
            Group = "Grup: ",
            Gender = "Gen: ",
            Age = "Varsta: ",
            ...
            undress = { label = "Dezbraca", desc = "Inlatura toate hainele" },
            dress = { label = "Imbraca", desc = "Pune toate hainele" },
        ...
        Secondchance = {
            title = "A Doua Sansa",
            DescAppearance = "fata corp machiaj inaltime par",
        ...
        MenuCreation = {
            ...
            element = { label = "Aspectul Caracterului", desc = "Alege aspectul caracterului tau" },
            element2 = { label = "Meniu Imbracaminte", desc = "Alege imbracamintea caracterului" },
            element3 = {
                label = "Alege un Nume",
                desc =
                "Alege un nume pentru caracterul tau si asigura-te ca citesti regulile privind numele caracterelor,<br> daca nu urmezi regulile, acest caracter va fi sters fara avertisment"
            },
            element4 = { label = "Incepe Aventura", desc = "Incepe-ti calatoria apasand Enter" },
            element5 = { label = "Varsta", desc = "Varsta caracterului tau" },
            element6 = {
                label = "Descrierea Caracterului",
                desc = "Descrie-ti caracterul si aspectul cat mai precis posibil, astfel incat sa te putem identifica.",
                desc2 = "Adaugat",
            },
            element7 = {
                label = "Alege o Porecla",
                desc = "Cum vrei sa te cheme oamenii? Sau sub ce porecla esti cunoscut?",
                desc2 = "Exemplu: Popcorn Sutton",
                nickname = "Porecla",
            },
            charname = "Nume Caracter",
            none = "Gol!",
            finish = "Completeaza totul mai intai!",
        },
        MenuClothes = {
            title       = "Creator Caracter",
            subtitle    = "Meniu Imbracaminte",
            CoatClosed  = "Paltoane Inchise",
            Coat        = "Paltoane",
            Hat         = "Palarii",
            EyeWear     = "Ochelari",
            Mask        = "Masti",
            NeckWear    = "Accesorii pentru Gat",
            NeckTies    = "Cravate",
            Shirt       = "Camasi",
            Suspender   = "Bretele",
            Vest        = "Veste",
        ...
        MenuOutfits = {
            title = "Ținute",
            subtitle = "Submeniu",
            option = "Alege una dintre tinutele tale",
            Select = "Selecteaza",
            Delete = "Sterge",
            inputHeader = "Repeta numele tinutei pentru a confirma:",
            inputHeader2 = "Numele noii tinutei:",
            outfitName = "Nume tinuta",
        },
        PayToShop = {
            DontMoney = "Nu ai suficient %s. Suma este: $%s",
            Youpaid = "Ai platit $%s",
            Total = 'Total:',
            Tokens = 'Fise: ',
            Currency = '$',
            notenoughtMoney = "Nu ai indeajuns : %s pretul este: $%d",

        },
        MenuAppearance = {
            title = "Aspect",
            subtitle = "Submeniu",
            element = { label = "Corp", desc = "Alege tipul corpului caracterului tau" },
            element2 = { label = "Caracteristici", desc = "Alege caracteristicile caracterului tau", desc2 = "optiuni pentru piele si cap" },
            element3 = { label = "Par", desc = "Alege tipul parului caracterului tau", desc2 = "optiuni pentru par, sprancene, gene" },
            element4 = { label = "Imbatranire", desc = "Varsta caracterului", desc2 = "riduri si semne de imbatranire" },
            element5 = { label = "Inaltime", desc = "Alege tipul corpului caracterului tau<br> Inalt 3 Normal 2 Scurt 1 " },
            element6 = { label = "Caracteristici Corp", desc = "Alege intre modificari la partea superioara sau inferioara a corpului, fata, capul, buzele, ochii etc.", desc2 = "obraz, urechi, ochi, nas " },
            element7 = { label = "Stil de Viata", desc = "Alege stilul de viata al caracterului tau", desc2 = "arsuri de soare, pete, pistrui " },
        ...
        MenuAge = {
            title = "Varsta",
            subtitle = "Submeniu",
            element = { label = "Varsta", desc = "Alege varsta caracterului tau" },
            element2 = { label = "Opacitate", desc = "exista ", desc2 = "Alege opacitatea varstei caracterului tau", desc3 = "cu o valoare maxima de 10" },
            label3 = "Invizibil",
            label4 = "Vizibil ",
        },
        MenuBody = {
            title = "Corp",
            subtitle = "Submeniu",
            element = { label = "Tip corp", desc = "exista ", },
            element2 = { label = "Talie", desc = "exista #", desc2 = "tipuri de talie" },
            element3 = { label = "Torso", desc = "exista " },
            element4 = { label = "Picioare", desc = "exista " },
            Ammount = " Cantitate "
        },
        MenuHeritage = {
            title = "Caracteristici",
            subtitle = "Submeniu",
            element = { label = "Culoare piele", desc = "exista ", desc2 = "tipuri de culoare a pielii " },
            element2 = { label = "Tipuri ", desc = "Alege tipul fetei caracterului tau" },
            element3 = { label = "Caracteristica #", desc = "exista #", desc2 = "tipuri de caracteristici" },
        },
        MenuHair = {
            title = "Par",
            subtitle = "Submeniu",
            element = { label = "Par", desc = "Alege parul caracterului", desc2 = "coafuri par" },
            element2 = { label = "Barba", desc = "Alege barba caracterului", desc2 = "par facial" },
            element3 = { label = "Barba tunsa", desc = "Alege barba tunsa a caracterului", desc2 = "coafuri barba tunsa" },
            element4 = { label = "Accesorii pentru Par", desc = "Alege accesorii pentru par", desc2 = "accesorii pentru par" },
            element5 = { label = "Sprancene", desc = "Alege sprancenele caracterului", desc2 = "coafuri sprancene" },
            element6 = { label = "Suprapunere", desc = "Alege suprapunerea parului caracterului", desc2 = "coafuri cu parul ras" },
        },
        MenuHairSelection = {
            title = "Par",
            subtitle = "Submeniu",
            element = { label = "Componenta ", desc = "exista ", desc2 = "tipuri de " },
            element2 = { label = "Culori Componenta", desc = "exista ", desc2 = "tipuri de culori pentru " },
            element3 = { label = "Elimina", desc = "Elimina aceasta componenta pentru a fi chel" },
        },
        MenuBeardEyeBrows = {
            title = "Aspect",
            subtitle = "Submeniu",
            ...
            element3 = { label = "Opacitate", desc = "Alege Opacitatea", desc2 = "Opacitate maxima 10" },
            element4 = { label = "Elimina", desc = "Elimina aceasta componenta pentru a fi chel" },
        },
        MenuFacial = {
            title = "Trasaturi Faciale",
            subtitle = "Submeniu",
            element = { label = "Culoare Ochi", desc = "culoarea ochilor" },
            element2 = { label = "Dinti", desc = "tipul de dinti" },
            element3 = { label = "Maxilar", desc = "ajustare oase maxilare", desc2 = "latime inaltime adancime" },
            element4 = { label = "Barbie", desc = "ajustare os barbie" },
            element5 = { label = "Dimensiune cap", desc = "ajustare dimensiune cap", desc2 = "inaltime" },
            element6 = { label = "Nas", desc = "ajustare nas", desc2 = "latime inaltime adancime unghi curbura" },
            element7 = { label = "Urechi", desc = "ajustare dimensiune urechi", desc2 = "latime inaltime dimensiune unghi" },
            element8 = { label = "Gura si Buze", desc = "ajustare gura si buze", desc2 = "buza superioara buza inferioara" },
            element9 = { label = "Oase obraz", desc = "Alege opacitatea parului facial", desc2 = "latime inaltime adancime" },
            element10 = { label = "Ochi si sprancene", desc = "ajustare oase obraz", desc2 = "pleoapa superioara ochi sprancene" },
            element11 = { label = "Corp superior", desc = "ajustare corp superior", desc2 = "sold talie piept brate" },
            element12 = { label = "Corp inferior", desc = "ajustare corp inferior", desc2 = "picioare vitel" },
        ...
        MenuFaceModify = {
            title = "Trasaturi Faciale",
            subtitle = "Submeniu",
            element = { label = "", desc = "selectie curenta: " },
        },
        MenuLifeStyle = {
            title = "Stil de Viata",
            subtitle = "Submeniu",
            ...
            element = { label = "Bataturi", desc = "Alege stilul de viata al caracterului tau" },
            element2 = { label = "Petice", desc = "Alege opacitatea stilului de viata a caracterului tau" },
            element3 = { label = "Complex", desc = "Alege opacitatea stilului de viata a caracterului tau" },
            element4 = { label = "Acnee", desc = "Alege opacitatea stilului de viata a caracterului tau" },
            element5 = { label = "Pistrui", desc = "Alege opacitatea stilului de viata a caracterului tau" },
            element6 = { label = "Decolorare", desc = "Alege opacitatea stilului de viata a caracterului tau" },
            element7 = { label = "Cicatrici", desc = "Alege opacitatea stilului de viata a caracterului tau" },
            element8 = { label = "Murdarie", desc = "Alege opacitatea stilului de viata a caracterului tau" },
            scroll = "deruleaza pe laturi pentru a aplica"
        },
        MenuMakeup = {
            title = "Machiaj",
            subtitle = "Submeniu",
            element = { label = "Ruj", desc = "Alege machiajul caracterului tau" },
            element2 = { label = "Ruje", desc = "Alege machiajul caracterului tau" },
            element3 = { label = "Eyeliner", desc = "Alege machiajul caracterului tau" },
            element4 = { label = "Umbra", desc = "Alege machiajul caracterului tau" },
            element5 = { label = "Textura", desc = "Alege machiajul caracterului tau", desc2 = "maxim" },
            element6 = { label = "Culoare", desc = "Alege machiajul caracterului tau" },
            element7 = { label = "Culoare secundara", desc = "Alege machiajul caracterului tau", desc2 = " maxim 10" },
            element8 = { label = "Varianta", desc = "Alege varianta de machiaj" },
            element9 = { label = "Opacitate", desc = "Alege machiajul caracterului tau", desc2 = " maxim 0.9" },
